...
class Codepress_Column_Shortcodes {
	...
	public function admin_styles() {
		if ( $this->has_permissions() && $this->is_edit_screen() ) {
			...
			wp_enqueue_style( 'cpsh-admin', get_template_directory_uri() . '/inc/column-shortcodes/assets/css/admin.css', array(), CPSH_VERSION, 'all' );

			if ( is_rtl() ) {
				wp_enqueue_style( 'cpsh-admin-rtl', get_template_directory_uri() . '/inc/column-shortcodes/assets/css/admin-rtl.css', array(), CPSH_VERSION, 'all' );
			}
		}
	}
	...
	public function admin_scripts( $plugins ) {
		if ( $this->has_permissions() && $this->is_edit_screen() ) {
			wp_enqueue_script( 'cpsh-admin', get_template_directory_uri() . '/inc/column-shortcodes/assets/js/admin.js', array( 'jquery' ), CPSH_VERSION );
			wp_enqueue_script( 'jquery-cookie', get_template_directory_uri() . '/inc/column-shortcodes/assets/js/jquery.ck.js', array( 'jquery' ), CPSH_VERSION );
		}
	...
	public function frontend_styles() {
		...
		// 	if ( ! is_rtl() ) {
		// 		wp_enqueue_style( 'cpsh-shortcodes', get_template_directory_uri() . '/inc/column-shortcodes/assets/css/shortcodes.css', array(), CPSH_VERSION, 'all' );
		// 	}
		// 	else {
		// 		wp_enqueue_style( 'cpsh-shortcodes-rtl', get_template_directory_uri() . '/inc/column-shortcodes/assets/css/shortcodes-rtl.css', array(), CPSH_VERSION, 'all' );
		// 	}
		// }
	}
	...
	public function add_shortcode_button( $page = null, $target = null ) {
		...
		<a href="#TB_inline?width=640&amp;height=600&amp;inlineId=cpsh-wrap" class="thickbox button" title="<?php _e( 'Select shortcode', CPSH_TEXTDOMAIN ); ?>" data-page="<?php echo $page; ?>" data-target="<?php echo $target; ?>">
			<img src="<?php echo get_template_directory_uri() . '/inc/column-shortcodes/assets/images/shortcode.png'; ?>" alt=""/>
		</a>
		<?php
	}
